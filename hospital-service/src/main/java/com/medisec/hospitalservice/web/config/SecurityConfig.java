...
//                .csrf().disable();
        ...
        http
                ...
                .antMatchers(HttpMethod.POST, "/api/service-log").hasAuthority("admin")
                ...
                .antMatchers(HttpMethod.GET, "/api/rule/**").hasAnyAuthority("doctor", "admin")
                .antMatchers(HttpMethod.POST, "/api/rule").hasAnyAuthority("doctor", "admin")
