...
//                .csrf().disable();
        ...
        http
                ...
                .antMatchers(HttpMethod.POST, "/api/firewall-log").permitAll()
                .antMatchers(HttpMethod.GET, "/api/medical-record/**").permitAll()
                .antMatchers(HttpMethod.POST, "/api/medical-record/**").permitAll()
                .antMatchers("/**").hasAuthority("admin")
                .and()
                .requiresChannel()
                .anyRequest()
